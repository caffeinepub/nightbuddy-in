...
export class Backend implements backendInterface {
    ...
    async getAllSignupsSorted(): Promise<Array<Signup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSignupsSorted();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllSignupsSortedByEmail(): Promise<Array<Signup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSignupsSortedByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSignup(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSignup(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
